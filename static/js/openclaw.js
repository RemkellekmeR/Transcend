(function () {
    ...
    const MODEL_RAM_DATA = [
        ...
        // Cloud models
        { name: "GPT-4o",               type: "cloud",  provider: "OpenAI",     ramMin: 0, ramRec: 0, vramMin: 0, quality: "exceptional", capabilities: "Best general reasoning, vision, tool use",     tags: ["chat", "coding", "reasoning", "tool-use", "vision"], context: "128K", install: "OPENAI_API_KEY=sk-proj-..." },
        { name: "GPT-4o Mini",          type: "cloud",  provider: "OpenAI",     ramMin: 0, ramRec: 0, vramMin: 0, quality: "great",       capabilities: "Fast, cheap, good for most agent tasks",       tags: ["chat", "coding", "tool-use"],    context: "128K", install: "OPENAI_API_KEY=sk-proj-..." },
        { name: "Claude Opus 4.6",      type: "cloud",  provider: "Anthropic",  ramMin: 0, ramRec: 0, vramMin: 0, quality: "exceptional", capabilities: "Most capable Claude, advanced reasoning, 1M context", tags: ["chat", "coding", "reasoning", "tool-use", "vision"], context: "200K (1M beta)", install: "ANTHROPIC_API_KEY=sk-ant-api03-..." },
        { name: "Claude Sonnet 4.5",    type: "cloud",  provider: "Anthropic",  ramMin: 0, ramRec: 0, vramMin: 0, quality: "exceptional", capabilities: "Best balance of speed, intelligence, and cost", tags: ["chat", "coding", "reasoning", "tool-use"], context: "200K", install: "ANTHROPIC_API_KEY=sk-ant-api03-..." },
        { name: "Claude Haiku 4.5",     type: "cloud",  provider: "Anthropic",  ramMin: 0, ramRec: 0, vramMin: 0, quality: "great",       capabilities: "Fast, cost-effective agent backbone",          tags: ["chat", "coding", "tool-use"],    context: "200K", install: "ANTHROPIC_API_KEY=sk-ant-api03-..." },
    ...
    const TROUBLESHOOT_DATA = [
        ...
        },
        {
            ...
            answer: '<ul><li>Ensure the key is set correctly in <code>.env</code> (no quotes needed for most)</li><li>OpenAI keys now use the <code>sk-proj-</code> prefix (legacy <code>sk-</code> keys are deprecated)</li><li>Anthropic keys use the <code>sk-ant-api03-</code> prefix &mdash; check yours matches</li><li>Check the key hasn\'t expired or been revoked on the provider dashboard</li><li>Verify billing is set up (many providers require a payment method even for free credits)</li><li>Check rate limits &mdash; you may have exceeded your quota</li><li>Ensure the env variable name matches exactly: <code>OPENAI_API_KEY</code>, <code>ANTHROPIC_API_KEY</code>, etc.</li><li>Restart OpenClaw after changing <code>.env</code> (changes aren\'t hot-reloaded)</li></ul>'
        },
        {
